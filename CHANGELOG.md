...
### Added
 ...
 - support for pitch fitting to avoid particular pitches

 - support for pitch fitting to use a backup strategy if the main one doesn't succeed
...
- octave & toOctave number extensions

- root & pitches properties added to IPitchContainer

- bass property added to Chord

- Chord.getPitchByDegree

- Chord.transpose & Scale.getTransposedScale

### Changed

- Renamed Scale.degree to Scale.getPitchByDegree

- Renamed Chord.getPitch to Chord.getPitchByIndex
